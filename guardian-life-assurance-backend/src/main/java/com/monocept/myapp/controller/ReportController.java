...
public class ReportController {
	...
	@Operation(
		    summary = "Generate Customer PDF Report",
		    description = "Generates a PDF report of customers based on provided filters such as name, city, state, and status. Supports pagination and sorting."
		)
    ...
    @PreAuthorize("hasRole('ADMIN') or hasRole('EMPLOYEE')")
    @Operation(
    	    summary = "Generate Agent PDF Report",
    	    description = "Generates a PDF report of agents based on filters such as name, city, state, and active status. Supports pagination and sorting."
    	)
    ...
    @Operation(
    	    ...
    	    description = "Generates a PDF report of payments based on filters such as amount range, date range, customer ID, and payment ID. Supports pagination and sorting."
    	)
    ...
    @Operation(
    	    summary = "Generate Withdrawal PDF Report",
    	    description = "Generates a PDF report of withdrawal requests based on filters such as customer ID, agent ID, status, and date range. Supports pagination and sorting."
    	)
    ...
    @PreAuthorize("hasRole('ADMIN') or hasRole('EMPLOYEE')")
    @Operation(
    	    summary = "Generate Commission Withdrawal PDF Report",
    	    description = "Generates a PDF report of commission withdrawals with filters such as agent ID, status, and date range. Supports pagination and sorting."
    	)
    ...
    @PreAuthorize("hasRole('ADMIN') or hasRole('EMPLOYEE')")
    @Operation(
    	    summary = "Generate Commission PDF Report",
    	    description = "Generates a PDF report of commissions based on filters such as agent ID, commission type, date range, and amount. Supports pagination and sorting."
    	)
    ...
    @Operation(
    	    summary = "Generate Agent Earnings PDF Report",
    	    description = "Generates a PDF report of agent earnings based on filters such as amount range and date range. Supports pagination."
    	)
    public ResponseEntity<byte[]> generateAgentEarningsReport(
        ...
        PagedResponse<AgentEarningsResponseDto> earnings = agentEarningsService.getAgentEarningsWithFilters(minAmount, maxAmount, fromFormatedDate, toFormatedDate, page, size);
